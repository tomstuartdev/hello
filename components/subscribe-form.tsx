        ...
        <div className="w-full max-w-xs mx-auto shrink-0">
          <form className="relative">
            ...
            <div className="space-y-3">
              ...
              <div>
                <button className="btn h2 uppercase text-xl text-neutral-100 bg-neutral-900 hover:bg-neutral-800 dark:text-neutral-800 dark:bg-[#A8FF00] dark:hover:bg-white w-full">
                  Join The Waitlist
                </button>
              </div>
            </div>
